...
class ResumableStorage(object):
    ...
    def get_chunk_storage(self, *args, **kwargs):
        ...
        """
        chunk_storage_cls = import_string(self.chunk_storage_class_name)
        return chunk_storage_cls(*args, **kwargs)
    ...
    def get_persistent_storage(self, *args, **kwargs):
        ...
        Defaults to django.core.files.storage.FileSystemStorage.
        """
        persistent_storage_cls = import_string(self.persistent_storage_class_name)
        return persistent_storage_cls(*args, **kwargs)
